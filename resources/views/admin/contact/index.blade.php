...
<section class="content-header">
  ...
  <ol class="breadcrumb pull-left">
    ...
    <li class="active"><a href="{{ url('/controlpanel/contact') }}">التحكم فى الرسائل 
    </a></li>
  </ol>
</section>
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">التحكم فى الرسائل </h3>
        </div><!-- /.box-header -->
        <div class="box-body">
  ...
  */
      ...
      $('#data thead th').each( function () {
          if($(this).index()  < 3 || $(this).index() == 6 ){
            ...
            $(this).html( '<select><option value="0">  لم تقراء </option><option value="1">  تم </option></select>' );
          }
          else if($(this).index() ==  5){
            $(this).html( '<select><option value="0"> الموضوع </option><option value="1"> اعجاب </option><option value="2"> مشكلة  </option> <option value="3"> اقتراح  </option> <option value="4"> استفسار  </option> </select>' );
      ...
      var table = $('#data').DataTable({
          ...
          ajax: '{{ url('/controlpanel/contact/data') }}',{{--  #هيروح فين   --}}
          columns: [
            {data: 'id', name: 'id'},
            ...
            {data: 'contact_subject', name: 'contact_subject'},
